...
const WELCOME_MESSAGE: ChatMessage = {
  role: 'assistant',
  content:
    'Hello! 👋 I am the Store AI assistant. You can ask me about products, for example: "I want a laptop under $600" or "Suggest self-help books". How can I help you today?',
};
